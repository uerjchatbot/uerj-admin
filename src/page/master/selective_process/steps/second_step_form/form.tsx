...
import { ProcessSecondStepData, Question } from "@/models/Question";
      ...
      <S.ContainerCards>
        <S.ContentCard>
          <S.ContentCardHeader>
            ...
            {documentation && <span dangerouslySetInnerHTML={{ __html: documentation.question }} />}
          </S.ContentCardHeader>
        ...
        <S.ContentCard>
          <S.ContentCardHeader>
            ...
            {step && <span dangerouslySetInnerHTML={{ __html: step.question }} />}
          </S.ContentCardHeader>
        ...
        <S.ContentCard>
          <S.ContentCardHeader>
            ...
            {discretion && <span dangerouslySetInnerHTML={{ __html: discretion.question }} />}
          </S.ContentCardHeader>
        ...
        <S.ContentCard>
          <S.ContentCardHeader>
            ...
            {enrollment && <span dangerouslySetInnerHTML={{ __html: enrollment.question }} />}
          </S.ContentCardHeader>
