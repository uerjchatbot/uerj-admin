...
const EditHandbagQuestion = ({ question, setQuestion }) => {
    ...
    const renderTextEditor = useCallback(() => {
        ...
        return (_jsxs(_Fragment, { children: [_jsxs(S.QuestionContainer, { children: [_jsx(DotRounded, { children: "4" }), _jsx(TextEditor, { value: textQuestion, setValue: setTextQuestion })] }), _jsxs(S.QuestionContainer, { children: [_jsx("span", {}), _jsx(TextEditor, { value: textTitle, setValue: setTextTitle })] })] }));
    }, [question]);
