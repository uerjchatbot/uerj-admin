...
`;
export const SwitchStageButton = styled.button `
  width: max-content;
  padding: 0.75rem 1.5rem;
  margin: 0 0.3rem;

  background-color: ${({ isSelected }) => isSelected ? Theme.colors.blue.normalBlue : Theme.colors.blue.extraLightBlue};
  color: ${({ isSelected }) => isSelected ? Theme.colors.white.white : Theme.colors.blue.blueDark};
