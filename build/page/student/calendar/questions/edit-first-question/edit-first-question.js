...
const EditFirstQuestion = ({ question, setQuestion }) => {
    ...
    const renderTextEditor = useCallback(() => {
        ...
        return (_jsxs(_Fragment, { children: [_jsxs(QuestionContainer, { children: [_jsx(DotRounded, { children: "1" }), _jsx(TextEditor, { value: textQuestion, setValue: setTextQuestion })] }), _jsx(TextEditor, { value: textTitle, setValue: setTextTitle })] }));
    }, [question.title]);
...
//# sourceMappingURL=edit-first-question.js.map