...
const EditThirdQuestion = ({ question, setQuestion }) => {
    ...
    const renderTextEditor = useCallback(() => {
        ...
        return (_jsxs(_Fragment, { children: [_jsxs(QuestionContainer, { children: [_jsx(DotRounded, { children: "3" }), _jsx(TextEditor, { value: textQuestion, setValue: setTextQuestion })] }), _jsx(TextEditor, { value: textTitle, setValue: setTextTitle })] }));
    }, [question.title]);
...
//# sourceMappingURL=edit-third-question.js.map